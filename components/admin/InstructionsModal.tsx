            ...
            <div className="space-y-4">
              ...
              <div className="bg-yellow-50 p-4 rounded-lg">
                ...
                <ul className="text-sm text-yellow-700 space-y-1">
                  <li>• <strong>SKU внутреннее заполнено</strong> → товар будет обновлен (если найден в той же категории)</li>
                  <li>• <strong>SKU внутреннее пустое</strong> → будет создан новый товар с автоматическим SKU</li>
              ...
              <div className="bg-red-50 p-4 rounded-lg border border-red-200">
                ...
                <ul className="text-sm text-red-700 space-y-1">
                  ...
                  <li>• При создании нового товара все обязательные поля шаблона должны быть заполнены</li>
                  <li>• При обновлении товара можно указывать только необходимые поля</li>
                </ul>
              </div>
            </div>
          </Card>
