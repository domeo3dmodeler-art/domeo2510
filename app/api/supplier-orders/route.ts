...
export async function POST(request: NextRequest) {
  ...
  try {
    ...
    logger.error('Error creating supplier order', 'supplier-orders/POST', { error }, loggingContext);
    return NextResponse.json(
...
export async function GET(request: NextRequest) {
  ...
  try {
    ...
    logger.error('Error fetching supplier orders', 'supplier-orders/GET', { error }, loggingContext);
    return NextResponse.json(
