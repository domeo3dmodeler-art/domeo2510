        ...
        subcategories: [
          {
            ...
            properties: [
              { key: "name", name: "Название", type: "text", required: true },
              { key: "category", name: "Категория", type: "text", required: true },
              { key: "price", name: "Цена", type: "number", required: true },
              { key: "description", name: "Описание", type: "text", required: true },
              { key: "features", name: "Возможности", type: "array", required: true }
            ],
            import_mapping: {
              "name": "name",
              "category": "category",
          ...
          },
          {
            ...
            description: "Камеры, датчики, сигнализации",
            icon: "🔒",
            is_main: false,
            parent_id: "smart",
            properties: [
          ...
          },
          {
            ...
            description: "Термостаты, кондиционеры",
            icon: "🌡️",
            is_main: false,
            parent_id: "smart",
            properties: [
          ...
          },
          {
            id: "smart-multimedia",
            name: "Мультимедиа",
            description: "Колонки, телевизоры, системы",
            icon: "📺",
            is_main: false,
            parent_id: "smart",
            properties: [
          ...
          },
          {
            id: "smart-sockets",
            name: "Умные розетки",
            description: "Розетки и удлинители с управлением",
            icon: "🔌",
            is_main: false,
            parent_id: "smart",
            properties: [
